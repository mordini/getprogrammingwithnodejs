...
// put ERRORS below routes.
// ERROR middleware functions acts like ELSE in if-elses, so it must check all first
app.use(errorController.logErrors); // use the error controller middleware
